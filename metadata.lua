...
--- Plugin description
PLUGIN.description = "zsh-autosuggestions plugin for zsh using vfox"
...
NOTE:
 ...
 --]]
PLUGIN.manifestUrl = "https://github.com/craftaholic/vfox-zsh-autosuggestions/releases/download/manifest/manifest.json"
